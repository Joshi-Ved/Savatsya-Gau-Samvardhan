...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white sticky top-0 z-50 border-b border-sawatsya-sand/50 shadow-md dark:bg-dark-navbar dark:border-dark-border dark:shadow-none">
            ...
            {isAuthenticated ? (
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56">
                  ...
                  <DropdownMenuSeparator />
                  <DropdownMenuItem onClick={handleLogout} className="focus:bg-red-50 dark:focus:bg-red-900/20 focus:text-red-600 dark:focus:text-red-400 cursor-pointer">
